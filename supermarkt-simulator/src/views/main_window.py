...
class MainWindow(QMainWindow):
    ...
    def create_sidebar(self):
        ...
        l_glob.addRow("Abgangsrichtung (Alle):", self.combo_global_exit)
    ...
    def update_sidebar_mode(self, mode_text):
        ...
        self.control_tabs.setTabVisible(1, not is_sim)
        self.control_tabs.setTabVisible(2, not is_sim)
        self.control_tabs.setTabVisible(3, is_sim)
