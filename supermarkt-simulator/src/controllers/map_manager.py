...
class MapManager:
    """
    Verwaltet die Datenstruktur der Supermarkt-Karte und die Datei-Operationen.
    """
    ...
    def load_map(self, map_name):
        ...
        @return: Tuple (Erfolg: bool, Globale Exit Richtung: str)
        """
    ...
    def save_map(self, global_exit_direction="Rechts"):
        ...
        data = {
            ...
            "shelves": [[p.x(), p.y()] for p in self.all_shelves],
