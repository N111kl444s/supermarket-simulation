...
Updated: Supports legacy 'skill' key for Cashiers.
"""
...
class VisualController:
    ...
    def _draw_single_checkout(self, cd, is_selected):
        ...
        if (
            ...
            # FIX: Prüfe sowohl neuen Key 'cashier_skill' als auch alten Key 'skill'
